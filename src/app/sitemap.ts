...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/guides/best-vpn-business-remote-workers`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/guides/best-ai-writing-assistant-content-marketing`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/guides/crm-nonprofit-organizations-comparison`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
